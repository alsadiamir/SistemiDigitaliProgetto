...
typematrix MATRIX_CONVERTED_FINAL[K_H][K_W] = {
			 // Gaussian blur
			  ...
			  {-1,0,131072},
			  {-1,0,65536} };
typematrix MATRIX_CONVERTED_H[K_H]={-1,0,65536};
typematrix MATRIX_CONVERTED_W[K_W]={-1,0,65536};
//
//typematrix MATRIX_CONVERTED_FINAL[K_H][K_W] = {
//			// 7x7
//		   {16,96,240,320,240,96,16},
//		   {96,576,1440,1920,1440,576,96},
//		   {240,1440,3600,4800,3600,1440,240},
//		   {320,1920,4800,6400,4800,1920,320},
//		   {240,1440,3600,4800,3600,1440,240},
//		   {96,576,1440,1920,1440,576,96},
//		   {16,96,240,320,240,96,16} };
//
//typematrix MATRIX_CONVERTED_ROW[K_H]= {16,96,240,320,240,96,16};
...
//		   {max,max,max,max,max,max,max} };
//
//typematrix MATRIX_CONVERTED_ROW[K_H]= {max,max,max,max,max,max,max};
...
//			printf("ok");
	...
	//riga W
	for(int i=0;i<K_H;i++)
		MATRIX_CONVERTED_W[i]=MATRIX_CONVERTED_FINAL[0][i];
...
void calcolo_uscita_stoc( type DATA_IN[HEIGHT_IMG*WIDTH_IMG], type DATA_OUT[HEIGHT_IMG*WIDTH_IMG]){
	...
	static type line_buffer_temp [K_H - 1];
...
void convolute_with_separability( type WINDOW_H[K_H], type *out, ap_uint<7> rand){
	...
	for(int i = 0; i < K_H; i++)
		{
			temp_v = temp_v + MATRIX_CONVERTED_ROW[i] * WINDOW_H[i];
		}
